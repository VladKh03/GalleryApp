        ...
        <div className="wrapper" ref={el => app = el}>
            <div className="content">
                <header className="hero-section">
                    <img data-speed=".6" className="hero" src={require("../../resources/img/hero.png")} alt="Alt" />
                    ...
                    <div className="container">
                        <div className="gallery" >
                            <div data-speed=".9" className="gallery__left">		
                                <img className="gallery__item" src={require('../../resources/img/work/1.jpg')} alt="Alt" />
                                <img className="gallery__item" src={require("../../resources/img/work/2.jpg")} alt="Alt" />		
                                ...
                                <img className="gallery__item" src={require("../../resources/img/work/6.jpg")} alt="Alt" />                              
                            </div>
                            <div data-speed="1.1" className="gallery__right">		
                                ...
                                <img className="gallery__item" src={require("../../resources/img/work/3.jpg")} alt="Alt" />
                                <img className="gallery__item" src={require("../../resources/img/work/4.jpg")} alt="Alt" />
                                <img className="gallery__item" src={require("../../resources/img/work/5.jpg")} alt="Alt" />                                    
                            </div>
                        </div>
                    </div>
                </div>
